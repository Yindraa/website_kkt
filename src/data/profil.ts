...
export const struktur: { jabatan: string; nama: string; foto?: string }[] = [
  ...
  { nama: "DEESY PANGKONG", jabatan: "Kaur Tata Usaha & Umum" },
  { nama: "EFRAIM SEPANG", jabatan: "Kaur Keuangan" },
  { nama: "OLIVIA Y. KAWATAK ", jabatan: "Kaur Perencanaan" },
  { nama: "GLORYNA L. SEPANG", jabatan: "Kasi Pemerintahan" },
  { nama: "FRANGKY W. TUMBOL", jabatan: "Kasi Kesejahteraan" },
  { nama: "TOMMY PUA", jabatan: "Kasi Pelayanan" },
  { nama: "JOHNY H. SEMBOR", jabatan: "Kepala Jaga I" },
  { nama: "FRANSISKUS PANGALILA", jabatan: "Kepala Jaga II" },
  { nama: "HARRY WAANI", jabatan: "Kepala Jaga III" },
  { nama: "PUJI C. WATULINGAS", jabatan: "Kepala Jaga IV" },
  { nama: "STEVEN A. PUSUNG", jabatan: "Kepala Jaga V" },
  { nama: "ROBBY LONTAAN", jabatan: "Kepala Jaga VI" },
  { nama: "ALEXANDER TULUNG", jabatan: "Meweteng I" },
  { nama: "ADAM E. PUA", jabatan: "Meweteng II" },
  { nama: "STEVY P. PANGKONG", jabatan: "Meweteng III" },
  { nama: "LIDYA I. TOALU", jabatan: "Meweteng IV" },
  { nama: "CHRISTDY M. KAUNANG", jabatan: "Meweteng V" },
  { nama: "LIDYA N. PANGKONG", jabatan: "Meweteng VI" },
];
